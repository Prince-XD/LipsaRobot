...
from LipsaRobot.modules import ALL_MODULES
from LipsaRobot.modules.helper_funcs.alternate import typing_action
from LipsaRobot.modules.helper_funcs.chat_status import is_user_admin
from LipsaRobot.modules.helper_funcs.misc import paginate_modules
from LipsaRobot.modules.helper_funcs.readable_time import get_readable_time

PM_START_TEXT = """
Hello there, I'm [𝙇𝙞𝙥𝙨𝙖](https://telegra.ph/file/51de93513eca8ddabfd3b.jpg) 
"""
...
buttons = [
    ...
    [
        InlineKeyboardButton(
            text="💫 Add Lipsa to your group 💫", url="t.me/LipsaRobot?startgroup=true"
        ),
    ],
]
...
HELP_STRINGS = f"""
*Main Commands :* [👰](https://telegra.ph/file/51de93513eca8ddabfd3b.jpg)
...
for module_name in ALL_MODULES:
    imported_module = importlib.import_module("LipsaRobot.modules." + module_name)
...
@run_async
def LipsaRobot_about_callback(update, context):
    query = update.callback_query
    if query.data == "aboutmanu_":
        query.message.edit_text(
            ...
            f"\n\nI Can Manage Your Groups Smoothly, With Some Special Features [:)](https://telegra.ph/file/51de93513eca8ddabfd3b.jpg)"
        ...
        query.message.edit_text(
            ...
            f"\n\nBased on [Lipsa](https://github.com/QueenArzoo/LipsaRobot)."
...
def main():
    ...
    about_callback_handler = CallbackQueryHandler(
        LipsaRobot_about_callback, pattern=r"aboutmanu_"
    )
