...
import LipsaRobot.modules.sql.feds_sql as sql
from LipsaRobot import DRAGONS, EVENT_LOGS, LOGGER, OWNER_ID, TIGERS, WOLVES, dispatcher
...
from LipsaRobot.modules.helper_funcs.string_handling import markdown_parser
